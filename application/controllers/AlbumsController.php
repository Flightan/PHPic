...
class AlbumsController extends Zend_Controller_Action
{
	...
	public function indexAction() {
		...
		if (empty($album))
		{
			...
			if (@$xml = simplexml_load_file($xmlpath . '/album_'.$user.'.xml'))
			{
			...
			else
			{
				...
				. "\t\t</div>\n"
				. "\t\t<div class='content'>\n";
				$this->view->html .= "<p>Error: Cannot find the album config, please make sure you have ran the launch.sh script.</p>\n";
			}
